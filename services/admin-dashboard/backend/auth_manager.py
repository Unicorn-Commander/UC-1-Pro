...
class AuthManager:
    ...
    def change_password(self, user_id: str, password_change: PasswordChange) -> bool:
        ...
        if not self._verify_password(password_change.current_password, user_data.get('password_hash', '')):
            return False
